...
pygame.display.set_caption('Беги Дино! Беги!')
...
def print_text(message, x, y, font_color=(0, 0, 0), font_type='19247.ttf', font_size=36):
...
def pause():
    ...
    while paused:
        ...
        print_text('Пауза. Нажми enter для продолжения', 80, 300)
...
def game_over():
    ...
    while stopped:
        ...
        print_text('Конец игры.', 310, 200)
        print_text('Нажми ENTER для продолжения,', 150, 250)
        print_text('или ESCAPE для выхода из игры.', 150, 300)
